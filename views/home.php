...
<div class="card">
  ...
  <p>Browse available turfs. Login to place bookings and manage your account.</p>
  ...
  <div class="grid">
    <?php foreach ($featured as $t): ?>
      <div class="card turf-card">
        <img
          src="assets/turfs/uploads/<?php echo htmlspecialchars($t['image'] ?? 'default.jpg'); ?>"
          alt="Turf"
        >
        ...
        <div style="margin-top:12px;">
          <a href="index.php?page=turf-details&id=<?php echo $t['id']; ?>" class="btn btn-sm">View Details</a>
        </div>
      </div>
    <?php endforeach; ?>
  </div>
...
<div class="grid">
  <?php if (empty($turfs)): ?>
    <div class="card">No turfs available right now.</div>
  <?php endif; ?>
